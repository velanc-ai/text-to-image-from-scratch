...
class UNET_ResidualBlock(nn.Module):
    ...
    def __init__(self, in_channels: int, out_channels: int, n_time=1280):
        super().__init__()
        self.groupnorm_function = nn.GroupNorm(32, in_channels)
    ...
    def forward(self, feature, time):
        ...
        feature = self.groupnorm_function(feature)
...
class UNET(nn.Module):
    ...
    def __init__(self):
        ...
        self.decoder = nn.ModuleList([
            ...
            SwitchSequential(UNET_ResidualBlock(2560, 1280), UNET_AttentionBlock(8, 80)),

            SwitchSequential(UNET_ResidualBlock(2560, 1280), UNET_AttentionBlock(8, 80)),

            SwitchSequential(UNET_ResidualBlock(2560, 1280), UNET_AttentionBlock(8, 80), Upsample(640)),

            SwitchSequential(UNET_ResidualBlock(2560, 1280), UNET_AttentionBlock(8, 40)),
